...
from .const import (
    ...
    POLARIS_HUMIDDIFIER_4A_MODE_TYPE,
    ...
    HUMIDDIFIER_4A_AVAILABLE_MODES,
...
class PolarisHumidifier(PolarisBaseEntity, HumidifierEntity):
    ...
    def __init__(
        ...
        elif device_type in POLARIS_HUMIDDIFIER_4A_MODE_TYPE:
            self.my_operation_list = HUMIDDIFIER_4A_AVAILABLE_MODES
